      ...
      <nav className="main_container flex justify-between items-center ">
        ...
        <div>
          <ul className=" md:flex hidden">
            <li className="text-white font-light p-5 text-lg">Início</li>
            <li className="text-white font-light p-5 text-lg">
              <Link href="/como-utilizar">Como Utilizar</Link>
            </li>
            <li className="text-white font-light p-5 text-lg">Galeria</li>
            <li className="text-white font-light p-5 text-lg">Vídeos</li>
            <li>
